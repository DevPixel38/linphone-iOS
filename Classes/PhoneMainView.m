...
- (void)viewDidAppear:(BOOL)animated {
    ...
    BOOL isAllowed = [[NSUserDefaults standardUserDefaults] boolForKey:@"AntworkAllowed"];
    
    
    if (!isAllowed){
        LoginwithAntworkViewController *login = [[LoginwithAntworkViewController alloc] initWithNibName:@"LoginwithAntworkViewController" bundle:[NSBundle mainBundle]];
